...
class ImageBrowseResource(ItemResource):
    ...
    def getAdjacentImages(self, currentImage, currentFolder=None):
        ...
        if index >= len(allImages) - 1 and str(folder['_id']) == '5d9f675ae6291400c45dbb67':
            nextImage = {u'size': 3016797, u'_id': u'https://redcap.vanderbilt.edu/surveys/?s=HH3D3PMNM8', u'description': u'', u'baseParentType': u'collection', u'baseParentId': u'5d9f8f87e6291400c45dbb85', u'creatorId': u'5e2f35c7e7a8d01deb3964f3', u'folderId': u'5d9f675ae6291400c45dbb67', u'lowerName': u'survey.jpg', u'name': u'survey.JPG'}
        else:
