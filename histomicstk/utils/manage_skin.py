            ...
            for field in download_files:
                ...
                if int(r['day_0___0']) or int(r['day_reepithelization___0']) and (not exists or args.ignoreexisting):
                    ...
                    if filename_original:
                        ...
                        natiens_full_name = '_'.join([project_id, r['imaging_session'].rjust(2, '0'), r['imaging_device___1'] + FILE_FIELDS_VECTRA[field['field']]])
                        filename_output = natiens_full_name + suffix 
