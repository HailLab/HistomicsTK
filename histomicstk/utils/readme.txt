step1_main_read_json_mask Executable
...
================================
-step1_main_read_json_mask 
-run_step1_main_read_json_mask.sh (shell script for temporarily setting environment 
                                   variables and executing the application)
   -to run the shell script, type
   
       ./run_step1_main_read_json_mask.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v911, run the shell script as:
       ...
       ./run_step1_main_read_json_mask.sh /mathworks/home/application/v911
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_step1_main_read_json_mask.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
${LD_LIBRARY_PATH}:MR/v911/runtime/glnxa64:MR/v911/bin/glnxa64:MR/v911/sys/os/glnxa64:MR/v911/sys/opengl/lib/glnxa64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_step1_main_read_json_mask.sh 
