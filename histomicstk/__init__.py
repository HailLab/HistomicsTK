...
class GirderPlugin(plugin.GirderPlugin):
    ...
    def load(self, info):  # noqa
        ...
        ModelImporter.registerModel('aperio', Aperio, 'histomicstk')
        ModelImporter.registerModel('case', Case, 'histomicstk')
        ModelImporter.registerModel('cohort', Cohort, 'histomicstk')
        ModelImporter.registerModel('image', Image, 'histomicstk')
        ModelImporter.registerModel('pathology', Pathology, 'histomicstk')
        ModelImporter.registerModel('slide', Slide, 'histomicstk')
